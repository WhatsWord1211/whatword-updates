...
export default StyleSheet.create({
  ...
  animatedButton: {
    ...
    borderLeftColor: '#FFA366',
    borderBottomColor: '#CC5500',
    borderRightColor: '#CC5500',
    shadowColor: '#000',
    shadowOffset: { width: 0, height: 2 },
    shadowOpacity: 0.3,
    shadowRadius: 4,
  ...
  buttonGradientBase: {
    ...
    right: 0,
    bottom: 0,
    backgroundColor: '#FF8C42', // Fallback color (bright orange)
    borderRadius: rs(8, 10),
  },
  buttonInnerShadow: {
    position: 'absolute',
  ...
  howToPlayLink: {
    ...
    // Purple outline using text shadows
